...
namespace E_Shop.Data
{
    public partial class ApplicationDbContext : IdentityDbContext<Partenaire, Role, int, UserClaim, UserRole, UserLogin, RoleClaim, UserToken>
    {
        ...
        public virtual DbSet<BcDetail> BcDetails { get; set; }
        ...
        public virtual DbSet<PaieTransact> PaieTransacts { get; set; }
...
//                optionsBuilder.UseSqlServer("Server=.\\;Database=EShop;Trusted_Connection=True;");
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => new { e.Prodid, e.Id, e.Btqid });
            ...
            {
                entity.HasKey(e => new { e.Categorieid, e.CatCategorieid });

                entity.HasOne(d => d.CatCategorie)
                    .WithMany(p => p.CatnavCatCategories)
                    .HasForeignKey(d => d.CatCategorieid)
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            {
                entity.HasKey(e => new { e.Id, e.Prodid, e.Btqid });
            ...
            modelBuilder.Entity<Litige>(entity =>
            {
                ...
                entity.HasOne(d => d.Remp)
                    .WithMany(p => p.Litiges)
                    .HasForeignKey(d => d.Rempid)
            ...
            modelBuilder.Entity<PaieTransact>(entity =>
            {
                entity.HasKey(e => new { e.Paiementid, e.Transactionid });

                entity.HasOne(d => d.Paiement)
                    .WithMany(p => p.PaieTransacts)
                    .HasForeignKey(d => d.Paiementid)
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            modelBuilder.Entity<RembTransact>(entity =>
            {
                entity.HasKey(e => new { e.Remboursementid, e.Transactionid });

                entity.HasOne(d => d.Remboursement)
                    .WithMany(p => p.RembTransacts)
                    .HasForeignKey(d => d.Remboursementid)
                    .OnDelete(DeleteBehavior.ClientSetNull)
