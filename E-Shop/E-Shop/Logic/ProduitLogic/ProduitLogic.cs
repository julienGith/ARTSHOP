...
namespace E_Shop.Logic.ProduitLogic
{
    public class ProduitLogic
    {
        ...
        {
            return await produit.AddProduit(boutiqueId, categorieId, livraisonTypeId, prix, nom, descriptionC, descriptionL, stock, disponibilite, rabais, preparation, seo, metaKw, metaTitre, publier);
        }
        //Modifier Produit
        public async Task<Produit> UpdateProduit(int prodId, int categorieId, int livraisonTypeId, decimal prix, string nom, string descriptionC, string descriptionL,
            short stock, short disponibilite, short rabais, short preparation, string seo, string metaKw, string metaTitre, bool publier)
        {
            return await produit.UpdateProduit(prodId, categorieId, livraisonTypeId, prix, nom, descriptionC, descriptionL, stock, disponibilite, rabais, preparation, seo, metaKw, metaTitre, publier);
        }
        //Delete Produit
