    ...
    public class CreateBoutiqueStep5Model : PageModel
    {
        ...
        public async Task<IActionResult> OnPost()
        {
            if (ModelState.IsValid)
            {
                ...
                step5.dateCreation = DateTime.Today.ToString("MM-dd-yyyy");
                var result = await boutiqueLogic.AddBoutique(step2.UserId, step4.Politiqueid, step5.BDescriptionC, step5.BDescriptionL, step2.Raisonsociale,step2.Nom, step2.Siret, step2.Siren, step2.Btqtel,
