...
namespace DAL.Migrations
{
    ...
    [Migration("20210318150247_identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Entities.Boutique", b =>
                {
            ...
            modelBuilder.Entity("DAL.Entities.Boutiquecommande", b =>
                {
            ...
            modelBuilder.Entity("DAL.Entities.Btqcmddetail", b =>
                {
                    b.Property<int>("Btqcmdid")
                        .HasColumnType("int")
                        .HasColumnName("BTQCMDID");
            ...
            modelBuilder.Entity("DAL.Entities.Btqposte", b =>
                {
                    b.Property<int>("Btqid")
                        .HasColumnType("int")
                        .HasColumnName("BTQID");
            ...
            modelBuilder.Entity("DAL.Entities.Categorie", b =>
                {
            ...
            modelBuilder.Entity("DAL.Entities.Catnav", b =>
                {
                    b.Property<int>("Categorieid")
                        .HasColumnType("int")
                        .HasColumnName("CATEGORIEID");
            ...
            modelBuilder.Entity("DAL.Entities.Civilite", b =>
                {
            ...
            modelBuilder.Entity("DAL.Entities.Clientcommande", b =>
                {
                    b.Property<int>("Cltcmdid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DAL.Entities.Cltcmddetail", b =>
                {
                    b.Property<int>("Cltcmdid")
                        .HasColumnType("int")
                        .HasColumnName("CLTCMDID");
            ...
            modelBuilder.Entity("DAL.Entities.Cmdetat", b =>
                {
                    b.Property<int>("Cmdetatid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DAL.Entities.Echange", b =>
                {
                    b.Property<int>("Partenaireid")
                        .HasColumnType("int")
                        .HasColumnName("PARTENAIREID");
            ...
            modelBuilder.Entity("DAL.Entities.Facture", b =>
                {
                    b.Property<int>("Factureid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DAL.Entities.Identification", b =>
                {
            ...
            modelBuilder.Entity("DAL.Entities.Litige", b =>
                {
                    b.Property<int>("Litigeid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DAL.Entities.Livraison", b =>
                {
                    b.Property<int>("Livraisonid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DAL.Entities.Livraisonetat", b =>
                {
                    b.Property<int>("Lvretatid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DAL.Entities.Livraisontype", b =>
                {
                    b.Property<int>("Lvrtypid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DAL.Entities.Localisation", b =>
                {
                    b.Property<int>("Localisationid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DAL.Entities.Medium", b =>
                {
            ...
            modelBuilder.Entity("DAL.Entities.Moyendepaiement", b =>
                {
            ...
            modelBuilder.Entity("DAL.Entities.Opinion", b =>
                {
                    b.Property<int>("Prodid")
                        .HasColumnType("int")
                        .HasColumnName("PRODID");
            ...
            modelBuilder.Entity("DAL.Entities.Paiement", b =>
                {
                    b.Property<int>("Paiementid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DAL.Entities.Panier", b =>
                {
            ...
            modelBuilder.Entity("DAL.Entities.Panierdetail", b =>
                {
                    b.Property<int>("Panierid")
                        .HasColumnType("int")
                        .HasColumnName("PANIERID");
            ...
            modelBuilder.Entity("DAL.Entities.Partenaire", b =>
                {
                    b.Property<int>("Partenaireid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DAL.Entities.Politique", b =>
                {
                    b.Property<int>("Politiqueid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DAL.Entities.Produit", b =>
                {
                    b.Property<int>("Prodid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DAL.Entities.Ptransact", b =>
                {
                    b.Property<int>("Paiementid")
                        .HasColumnType("int")
                        .HasColumnName("PAIEMENTID");
            ...
            modelBuilder.Entity("DAL.Entities.Remboursement", b =>
                {
                    b.Property<int>("Remboursementid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DAL.Entities.Remplacement", b =>
                {
            ...
            modelBuilder.Entity("DAL.Entities.Rtransact", b =>
                {
                    b.Property<int>("Remboursementid")
                        .HasColumnType("int")
                        .HasColumnName("REMBOURSEMENTID");
            ...
            modelBuilder.Entity("DAL.Entities.Boutique", b =>
                {
                    b.HasOne("DAL.Entities.Partenaire", "Partenaire")
                        .WithMany("Boutiques")
                        .HasForeignKey("Partenaireid")
                        .HasConstraintName("FK_BOUTIQUE_CREER_PARTENAI")
                        .IsRequired();

                    b.HasOne("DAL.Entities.Politique", "Politique")
                        .WithMany("Boutiques")
            ...
            modelBuilder.Entity("DAL.Entities.Btqposte", b =>
                {
                    ...
                    b.HasOne("DAL.Entities.Localisation", "Localisation")
                        .WithMany("Btqpostes")
            ...
            modelBuilder.Entity("DAL.Entities.Clientcommande", b =>
                {
                    ...
                    b.HasOne("DAL.Entities.Facture", "Facture")
                        .WithMany("Clientcommandes")
                        .HasForeignKey("Factureid")
                        .HasConstraintName("FK_CLIENTCO_GENERER2_FACTURE");

                    b.HasOne("DAL.Entities.Paiement", "Paiement")
                        .WithMany("Clientcommandes")
            ...
            modelBuilder.Entity("DAL.Entities.Identification", b =>
                {
                    b.HasOne("DAL.Entities.Civilite", "Civ")
            ...
            modelBuilder.Entity("DAL.Entities.Litige", b =>
                {
                    ...
                    b.HasOne("DAL.Entities.Remboursement", "Remboursement")
                        .WithMany("Litiges")
                        .HasForeignKey("Remboursementid")
                        .HasConstraintName("FK_LITIGE_DONNER2_REMBOURS");

                    b.HasOne("DAL.Entities.Remplacement", "Retour")
                        .WithMany("Litiges")
            ...
            modelBuilder.Entity("DAL.Entities.Livraison", b =>
                {
                    ...
                    b.HasOne("DAL.Entities.Livraisonetat", "Lvretat")
                        .WithMany("Livraisons")
                        .HasForeignKey("Lvretatid")
                        .HasConstraintName("FK_LIVRAISO_CARACTERI_LIVRAISO")
                        .IsRequired();

                    b.HasOne("DAL.Entities.Livraisontype", "Lvrtyp")
                        .WithMany("Livraisons")
            ...
            modelBuilder.Entity("DAL.Entities.Paiement", b =>
                {
                    ...
                    b.HasOne("DAL.Entities.Moyendepaiement", "Mdp")
                        .WithMany("Paiements")
                        .HasForeignKey("Mdpid")
            ...
            modelBuilder.Entity("DAL.Entities.Panierdetail", b =>
                {
                    b.HasOne("DAL.Entities.Panier", "Panier")
